...
/* C:\xampp\htdocs\newlifetrainingcenter-v2/themes/newlifetrainingcenter/partials/footer.htm */
class __TwigTemplate_3269cdac85654631e6fc021f58b63394902b52e0e62a12b0323130b917eee162 extends Twig_Template
{
...
\t\t";
    ...
    <script src=\"";
        // line 25
        echo $this->env->getExtension('CMS')->themeFilter(array(0 => "assets/javascript/sweetalert.min.js"));
        echo "\"></script>
    ...
    <script type=\"text/javascript\">
        \$(document).ready(function () {
          ...
          \$(document).on('ajaxErrorMessage', function(event, message){
              ...
              // var resp = jQuery.parseJSON(message);
              alert(message);
            // swal(\"Something wrong happened.\", resp['X_OCTOBER_ERROR_MESSAGE'], \"error\")
    ...
    {
        return array (  62 => 25,  57 => 23,  53 => 22,  45 => 17,  41 => 15,  34 => 14,  19 => 1,);
    }
}
/* <!-- Footer -->*/
/*     <footer>*/
...
/*     <!-- jQuery UI -->*/
/*     <script src="{{ ['assets/javascript/sweetalert.min.js']|theme }}"></script>*/
/* */
/*     <script type="text/javascript">*/
/*         $(document).ready(function () {*/
/*                 */
